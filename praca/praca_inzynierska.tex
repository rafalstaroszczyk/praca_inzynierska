...
\begin{document}
	...
	Wprowadza się wielkość zwaną źródłem entropii \(\sigma\), która oznacza generację entropii w jednostce czasu i objętości
	\begin{equation}
		\pdv{S}{t} = \iiint_{V}\sigma\dd{V}
	\end{equation}
	i jest wyrażona za pomocą sił termodynamicznych i przepływów jako: 
	\begin{equation}
	...
	\begin{table}[H]
		...
		\begin{tabular}{|c|c|c|c|}\cline{1-4}
			...
			\begin{tabular}{c} %41
				...
				\textbf{Siodło (zawsze niestabilne)}
			\end{tabular}
			& 
			\begin{tabular}{c} %42
				\(\lambda_{1}, \lambda_{2}\in\mathbb{R}\) \\
