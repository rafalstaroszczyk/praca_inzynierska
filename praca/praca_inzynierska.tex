...
\begin{document}
	...
	W późniejszym okresie znaleziono również inne reagenty, dla których zachodzi reakcja analogiczna. Jedną z możliwych modyfikacji tej reakcji jest zamiana jonów \ce{Ce^3+} na \ce{Fe(o-phen)3^2+}, zwanych ferroiną. Jej utleniona forma ma wzór \ce{Fe(o-phen)3^3+}. Podmiana ta zmienia efekty wizualne w czasie przebiegu reakcji oscylacyjnej. Zamiast oscylacji między bezbarwnym i żółtym roztworem występuje oscylacja między pomarańczowym oraz niebieskim \cite{orlik}. Jeszcze innym takim katalizatorem może być związek rutenu \ce{Ru(bpy)3^2+} wraz ze swoją formą utlenioną \ce{Ru(bpy)3^3+}. Oscylacje stosunku stężeń tych katalizatorów mogą się też objawiać w inny sposób niż zmiana koloru. \cite{osypova}\par
	\begin{figure}[H]
		\centering
		\begin{subfigure}{0.45\textwidth}
			\centering
