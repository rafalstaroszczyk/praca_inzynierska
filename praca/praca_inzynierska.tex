...
\begin{document}
	...
	W pracy zająłem się głównie reakcjami chemicznymi oscylacyjnymi, które są przykładem czasowej struktury dyssypatywnej. Struktur takich nie można rozpatrywać w ramach termodynamiki liniowej, ponieważ są one typowe jedynie dla stanów nierównowagowych. \par
	...
	\end{center}
	W reakcji tej obserwujemy, że stężenia \ce{Br-} zmieniają się oscylacyjnie. Równocześnie stężenia \ce{Ce^{3+}} oraz \ce{Ce^{4+}} też podlegają oscylacjom. Reakcja sumaryczna ma postać: 
	\begin{center}
	...
	W późniejszym okresie znaleziono również inne reagenty, dla których zachodzi reakcja analogowa. Powszechnym takim zamiennikiem jest \ce{Fe(o-phen)3^2+} w miejsce jonów \ce{Ce^3+}. Zmienia to kolory występujące w reakcji z bezbarwnego i żółtego na pomarańczony i niebieski \cite{orlik}. \par
	...
	\end{equation}
	Przekształcając równanie \eqref{dod A: 1} otrzymujemy:
	\begin{equation}
	...
	\section{Porównanie metod numerycznych}
